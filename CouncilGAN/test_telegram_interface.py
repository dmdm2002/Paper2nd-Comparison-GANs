...
parser.add_argument('--configs', type=str, default='configs/anime2face_council_folder.yaml', help='Path to the configs file.')
    ...
    try:
        ...
        for i in range(number_of_result_to_return):
            ...
            with open(out_image_path, 'rb') as res_file:
                ...
                # context.bot.send_photo(chat_id=update.message.chat_id, photo=res_file, filename=configs['misc']['telegram_report_add_prefix'], caption='output'+ 'face_increes_by_dev_ratio:'+ str(face_increes_by_dev_ratio) + ' move_up_by_ratio:' + str(move_up_by_ratio))
