...
parser.add_argument('--configs', type=str, default='configs/edges2handbags_folder', help='Path to the configs file.')
...
if 'gen_' in opts.checkpoint[-21:]:
    ...
    try:
       ...
       print('opts.a2b should be set to ' + str(not opts.a2b) + ' , Or configs file could be wrong')
